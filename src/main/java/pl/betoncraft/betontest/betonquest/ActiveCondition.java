...
/**
 * Checks if the player has an active test.
 *
 * @author Jakub Sapalski
 */
public class ActiveCondition extends Condition {

	private final Test test;
	private final BetonTest betonTest = BetonTest.getPlugin(BetonTest.class);

	public ActiveCondition(String packName, String instructions)
	...
	public boolean check(String playerID) {
		...
		if (test == null) {
			return betonTest.getActiveTest(player) != null;
		} else {
			Test active = betonTest.getActiveTest(player);
